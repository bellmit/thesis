package com.nikolaj.thesis.thesis.storage;
...
import static com.nikolaj.thesis.thesis.storage.StorageConstants.TEMPORARY_DIRECTORY;
...
public class FileSystemStorageService implements StorageService {
    ...
    public File storeTmpFile(MultipartFile file) {
        String fileDirPath = TEMPORARY_DIRECTORY + "/";
        String fullFilename = StringUtils.cleanPath(file.getOriginalFilename());
